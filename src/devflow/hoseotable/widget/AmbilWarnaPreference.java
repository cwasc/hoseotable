...
package devflow.hoseotable.widget;
...
import devflow.hoseotable.AmbilWarnaDialog;
...
public class AmbilWarnaPreference extends Preference {
	...
	public AmbilWarnaPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		setWidgetLayoutResource(devflow.hoseotable.R.layout.ambilwarna_pref_widget);
	}
	...
	@Override protected void onBindView(View view) {
		...
		final View kotak = view.findViewById(devflow.hoseotable.R.id.ambilwarna_pref_widget_kotak);
		if (kotak != null) {
